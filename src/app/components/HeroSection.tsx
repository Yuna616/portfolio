    ...
    >
      ...
      <div className="border border-neutral-200 bg-white overflow-hidden shadow-sm dark:border-white/[0.08] dark:bg-[#0c0c0c] dark:shadow-none">
        ...
        <div className="flex items-center gap-2 px-4 py-2.5 border-b border-neutral-200 bg-neutral-50 dark:border-white/[0.06] dark:bg-white/[0.015]">
          ...
          <span className="font-mono text-[10px] text-neutral-500 ml-3 uppercase tracking-widest dark:text-[#565656]">
            firmware.c
          </span>
        </div>
        ...
        <div className="space-y-2.5">
          {[
            ...
            <div key={key} className="flex justify-between items-baseline gap-4">
              <span className="font-mono text-[10px] text-neutral-500 uppercase tracking-wide shrink-0 dark:text-[#585858]">
                {key}
              </span>
              <span className="font-mono text-[11px] text-neutral-600 text-right dark:text-[#757575]">{val}</span>
            </div>
          ))}
        </div>
      </div>
        ...
        {TECH_TAGS.map((tag) => (
          <span
            ...
            className="font-mono text-[10px] uppercase tracking-wide px-2.5 py-1
                       ...
                       dark:border-white/[0.07] dark:text-[#5f5f5f] dark:hover:border-portfolio/25 dark:hover:text-[#9a9a9a]"
          >
            {tag}
          </span>
        ))}
...
export function HeroSection() {
  return (
    ...
    >
      ...
      >
        <p className="font-mono text-[10px] text-neutral-500 uppercase tracking-[0.35em] dark:text-[#5e5e5e]">
          Portfolio · 2025
        </p>
        <div className="flex items-center gap-2">
          <span className="w-1.5 h-1.5 rounded-full bg-portfolio animate-pulse" />
          <p className="font-mono text-[10px] text-neutral-500 uppercase tracking-[0.2em] dark:text-[#757575]">
            Open to work
          </p>
        </div>
      </motion.div>
      ...
      <div className="relative z-10 flex-1 flex flex-col lg:flex-row lg:items-center gap-10 lg:gap-14 py-10 md:py-12">
        ...
        >
          ...
          {/* Bio */}
          <p className="text-neutral-500 text-[15px] leading-[1.85] max-w-md mb-9 dark:text-[#a8a8a8]">
          ...
          <div className="flex flex-wrap gap-3 mb-8">
            ...
            <a
              ...
              className="inline-flex items-center gap-2 rounded-none font-mono text-[11px] uppercase tracking-[0.2em] px-7 py-3
                         ...
                         dark:border-white/[0.18] dark:text-[#b3b3b3]"
            >
          ...
          {/* Location */}
          <p className="font-mono text-[10px] text-neutral-500 uppercase tracking-[0.28em] dark:text-[#565656]">
      ...
      >
        ...
        <p className="font-mono text-[11px] text-neutral-500 leading-[1.8] uppercase tracking-[0.1em] dark:text-[#6f6f6f]">
